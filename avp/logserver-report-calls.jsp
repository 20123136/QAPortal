...
<script type="text/javascript" src="../js/highcharts3.0.5.src.js"></script>
<script type="text/javascript" src="../js/exporting3.0.5.src.js"></script>
	...
	Ext.onReady(function(){
		...
		var chart1 = new Ext.ux.HighChart({
			...
			chartConfig : {
				...
				// q	url: 'http://localhost:8080/highcharts-export',

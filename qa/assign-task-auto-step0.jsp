...
<head>
    ...
    <script type="text/javascript" src="../js/app/qa/QAPlannedDayTypeField2.js"></script>
    <script type="text/javascript" src="../js/app/qa/QAPlannedWeekTypeField2.js"></script>
    <script type="text/javascript" src="../js/app/qa/QAPlannedMonthTypeField2.js"></script>
	...
	Ext.onReady(function(){
		...
		// 计划完成时间日类型
		TaskConditionFields.push(new Ext.app.rec.QAPlannedDayTypeField2({
			hidden: false
		}));

		// 计划完成时间周类型
		TaskConditionFields.push(new Ext.app.rec.QAPlannedWeekTypeField2({
			hidden: false
		}));

		// 计划完成时间月类型
		TaskConditionFields.push(new Ext.app.rec.QAPlannedMonthTypeField2({
			hidden: false
		}));
							...
							'click': function(obj, e) {
								...
								if(parent.frames['tabStep1']) {
									...
									obj.targetTab.add({
										...
										autoWidth:true,
										closable:false,
										html:'<iframe name=tabStep1 src="assign-task-auto-step1.jsp" border=0 width="100%" height="100%" frameborder="no" scrolling="auto"></iframe>'
									}).show();
								}
							}
						}
		...
		//自动生成一个任务编号
		Ext.Ajax.request({
			url: window.webRoot + 'QASample/Task/GenerateNo/Auto',

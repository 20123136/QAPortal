/**
 * @class Ext.app.qa.QAStatusTwinTriggerField
 * @extends Ext.app.common.TwinTriggerField
 * 质检状态列表。
 */
Ext.ns('Ext.app.qa');
Ext.app.qa.QAStatusTwinTriggerField = Ext.extend(Ext.app.common.TwinTriggerField, {
	width: 530,
	fieldLabel: '质检状态',
	...
	initComponent : function(){
		...
		this.selectWin = new Ext.app.qa.QAStatusSelectorWindow({
			name: 'qaStatusWin',
			width: 720,
			height:435
		});
		...
		Ext.app.qa.QAStatusTwinTriggerField.superclass.initComponent.call(this);
	},

	getKey: function() {
		return this.name ? this.name : 'qaStatus';
	},
	...
	getUXType: function() {
		return 'QAStatusTwinTriggerField';
	}
});

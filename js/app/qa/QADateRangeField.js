/**
 * @class Ext.ux.QADateRangeField
 * @extends Ext.form.CompositeField
 * 创建时间范围选择框。
 */
Ext.ns('Ext.app.qa');

Ext.app.qa.QADateRangeField = Ext.extend(Ext.form.CompositeField, {
	fieldLabel: '开始时间',
	msgTarget: 'side',
	anchor: '-20',
    ...
    constructor: function(config){
		...
		Ext.app.qa.QADateRangeField.superclass.constructor.call(this, config);

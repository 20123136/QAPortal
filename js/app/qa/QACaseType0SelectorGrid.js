/**
 * @class Ext.app.qa.QACaseType0SelectorGrid
 * @extends Ext.app.common.Grid
 * 质检案例类型列表。
 */
Ext.ns('Ext.app.qa');

Ext.app.qa.QACaseType0SelectorGrid = Ext.extend(Ext.app.common.Grid, {
	...
	constructor: function(config){
		Ext.app.qa.QACaseType0SelectorGrid.superclass.constructor.call(this, config);
	...
	initComponent : function(){
		...
		Ext.app.qa.QACaseType0SelectorGrid.superclass.initComponent.call(this);
	},
	...
	getUXType: function() {
		return 'QACaseType0SelectorGrid';
	}
});

/**
 * @class Ext.app.qa.QACaseAttributeTwinTriggerField
 * @extends Ext.app.common.TwinTriggerField
 * 案例属性列表。
 */
Ext.ns('Ext.app.qa');
Ext.app.qa.QACaseAttributeTwinTriggerField = Ext.extend(Ext.app.common.TwinTriggerField, {
	width: 530,
	fieldLabel: '案例属性',
	...
	initComponent : function(){
		...
		this.selectWin = new Ext.app.qa.QACaseAttributeSelectorWindow({
		...
		Ext.app.qa.QACaseAttributeTwinTriggerField.superclass.initComponent.call(this);
	},

	getKey: function() {
		return this.name ? this.name : 'qaCaseAttribute';
	},
	...
	getUXType: function() {
		return 'QACaseAttributeTwinTriggerField';
	}
});

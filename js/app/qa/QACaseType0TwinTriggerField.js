/**
 * @class Ext.app.qa.QACaseType0TwinTriggerField
 * @extends Ext.app.common.TwinTriggerField
 * 案例属性列表。
 */
Ext.ns('Ext.app.qa');
Ext.app.qa.QACaseType0TwinTriggerField = Ext.extend(Ext.app.common.TwinTriggerField, {
	width: 530,
	fieldLabel: '案例类型',
	...
	initComponent : function(){
		...
		this.selectWin = new Ext.app.qa.QACaseType0SelectorWindow({
			name: 'qaCaseTypeWin',
			width: 720,
			height:435
		});
		...
		Ext.app.qa.QACaseType0TwinTriggerField.superclass.initComponent.call(this);
	},
	...
	getUXType: function() {
		return 'QACaseType0TwinTriggerField';
	}
});

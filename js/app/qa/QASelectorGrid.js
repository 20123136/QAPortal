...
Ext.app.qa.QASelectorGrid = Ext.extend(Ext.app.common.Grid, {
	...
	initComponent : function(){
		...
		console.log(me.recData);
		
/*		if(me.qaGroupType == null){
			me.qaGroupType = '51eb5710-8069-4c84-91a0-77d3af818c55';
		}*/
...
//			sortInfo:{field:'order',direction: 'ASC'},
		...
		this.store.on('beforeload', function(obj) {
			obj.removeAll();
			obj.proxy.setUrl(window.webRoot + 'QAItemGroup/'+ me.qaGroupType + '/Selector', true);
//			obj.removeAll();

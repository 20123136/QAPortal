 ...
 */
Ext.ns('Ext.app.rec');
Ext.app.rec.AgentTwinTriggerField = Ext.extend(Ext.app.common.TwinTriggerField, {
	width: 530,
	fieldLabel: '座席',
	editable:true,
	...
	initComponent : function(){
		...
		this.selectWin = new Ext.app.mgr.AgentUserSelectorWindow({
			name: 'agentUserWin',
			width: 720,
			height:432
		});
		...
		Ext.app.rec.AgentTwinTriggerField.superclass.initComponent.call(this);
	},

	getKey: function() {
		return this.name ? this.name : 'agentNo';
	},

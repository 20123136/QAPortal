 ...
 */
Ext.ns('Ext.app.rec');
Ext.app.rec.WechatUserTwinTriggerField = Ext.extend(Ext.app.common.TwinTriggerField, {
	width: 530,
	fieldLabel: '用户',
	editable:true,
	...
	initComponent : function(){
		...
		this.selectWin = new Ext.app.mgr.WechatUserSelectorWindow({
			name: 'wechatUserWin',
			width: 720,
			height:400
		});
		...
		Ext.app.rec.WechatUserTwinTriggerField.superclass.initComponent.call(this);
	},
	...
	getUXType: function() {
		return 'WechatUserTwinTriggerField';
	}
});

								...
								fn: function(btn, text) {
									if(btn == "yes") {
										...
										Ext.each(grid.getSelectionModel().getSelections(), function(rec) {
											ids.push(rec.get('tempId'));
										});
										Ext.Ajax.request({
											url: window.webRoot + 'WeChatTemp/enable',
											method: 'POST',
											params: {
												_method: 'PUT',
												id: ids
							...
							Ext.Msg.show({
								...
								fn: function(btn, text) {
									if(btn == "yes") {
										...
										Ext.Ajax.request({
											url: window.webRoot + 'WeChatTemp/disable',
											method: 'POST',
											params: {
												_method: 'PUT',
												id: ids
				...
				handler: function() {
					if(userForm.form.isValid()) {
						...
						if(actiontype == "edit") {
							...
							console.log(vals);
							userForm.form.submit({
								url: window.webRoot + 'WeChatTemp/' + vals.tempId,
								method: 'POST',
								params: {
									_method: 'PUT'
								},

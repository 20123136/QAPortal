...
<head>
    ...
    <script type="text/javascript" src="../js/colmun/Report_Query_Agent.js"></script>
					...
					listeners:
						{
							'click': function(obj, e) {
								...
								obj.targetTab.add({
									...
									autoWidth:true,
									closable:true,
									html:'<iframe src="rpt-rec-agent-result.jsp?type=' + ConditionFields[0].getVal() +'" border=0 width="100%" height="100%" frameborder="no" scrolling="auto"></iframe>'
								}).show();
							}
						}
				})

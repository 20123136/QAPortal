...
<head>
   ...
   <!--  <script type="text/javascript" src="../js/charts.swf"></script>--> 
	...
	Ext.onReady(function(){
		...
		var store = new Ext.data.JsonStore({
			...
			proxy: new Ext.data.HttpProxy({
				url: window.webRoot + 'Report/Record/<%=type%>',
				timeout: 300000
			}),
		...
		store.load({params:{start:0, limit:pagesize}});
		  ...
		  var store_sec = new Ext.data.JsonStore({
		        fields: ['season', 'total'],
		        data: [{
		            season: 'Summer',
		            total: 50

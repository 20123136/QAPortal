	...
	Ext.onReady(function(){
		var store = new Ext.data.JsonStore({
			...
			proxy: new Ext.data.HttpProxy({
				url: window.webRoot + 'Report/QARecord/DeptStat'
			}),
		...
		var groupColsObj =  [
			...
			{header: '质检组', colspan: 1, align: 'center'},
			{header: '质检统计', colspan: 2, align: 'center'},
		...
		store.on('load', function(obj, node) {
			...
			var p = new Ext.data.Record({  
				isStat: true,
				qaDeptName: '<b><font color=\'green\'>总计:</font></b>',

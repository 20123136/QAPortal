					...
					if(!node) {
						...
						Ext.Msg.show({
							...
							fn: function(btn, text) {
								if(btn == "yes") {
									Ext.Ajax.request({
										url: window.webRoot + 'rest/dept/' + node.attributes.id,
										method: 'POST',
										params: {
											_method: 'DELETE'
										},
						...
						if(!node) {
							...
							Ext.Msg.show({
								...
								fn: function(btn, text) {
									if(btn == "yes") {
										Ext.Ajax.request({
											url: window.webRoot + 'rest/dept/' + node.attributes.id + '/enable',
											method: 'POST',
											params: {
												_method: 'PUT'
											},   
						...
						if(!node) {
							...
							Ext.Msg.show({
								...
								fn: function(btn, text) {
									if(btn == "yes") {
										Ext.Ajax.request({
											url: window.webRoot + 'rest/dept/' + node.attributes.id + '/disable',
											method: 'POST',
											params: {
												_method: 'PUT'
											},
...
//			renderTo: Ext.getBody(),
			...
			dataUrl: window.webRoot + 'data/deptchildren.json'
		});
			...
			buttons: [{
				...
				handler: function() {
					...
					if(dptForm.form.isValid()) {
						...
						if(actiontype == "edit") {
							dptForm.form.submit({
								url: window.webRoot + 'rest/dept/' + vals.id,
								method: 'POST',
								params: {
									_method: 'PUT'
								},
		...
		tree.on('click', function(node, e) {
			...
			store_department_user.proxy.setUrl(window.webRoot + 'rest/dept/' + id + '/users', true);

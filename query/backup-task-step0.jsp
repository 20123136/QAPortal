...
<head>
	...
	Ext.onReady(function(){
							...
							'click': function(obj, e) {
								...
								if(parent.frames['tabStep1']) {
									...
									obj.targetTab.add({
										...
										autoWidth:true,
										closable:false,
										html:'<iframe name=tabStep1 src="backup-task-step1.jsp" border=0 width="100%" height="100%" frameborder="no" scrolling="auto"></iframe>'
									}).show();
								}
							}
						}
		...
		//自动生成一个任务编号
		Ext.Ajax.request({
			url: window.webRoot + 'QABackup/Task/GenerateNo/Manual',

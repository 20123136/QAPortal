...
<!--	<title>华帝 -- 录音查询及质检系统 登录</title> -->
	...
	Ext.onReady(function() {
		if(top.document.title != document.title) {
			top.document.location.href = "<%=webRoot%>/login.jsp";
		}
...
<body>
	...
	<div id="hello-tabs"><img border="0" width="430" height="60" src="./images/login_banner.jpg" />
	</div>
	</div>
	<div id="aboutDiv" class="x-hidden"
		style='color: black; padding-left: 10px; padding-top: 10px; font-size: 12px'>
	井星录音查询及备份系统 1.0v (Wilcom&reg)<br>
	<br>
	<br>
